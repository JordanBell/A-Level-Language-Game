package  {
	...
	public class Game extends Object{
		...
		/*public function submitAnswer(event:MouseClickEvent):void{
		...
		public function nextRound():void{
			...
			if ((chosenLanguage != null) && (chosenCategory != null) && (chosenDifficulty != null)){
				roundCount++;
				currentWord = currentWordlist[roundCount];
				//outputBox.text = chosenLanguage.fromEnglish(currentWord);
				trace("The new word is: " + currentWord);
				//wordCounter.text = roundCount;
				trace("The current round is: " + roundCount);
			}else{
